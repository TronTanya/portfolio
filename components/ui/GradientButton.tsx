...
export function GradientButton({
  ...
  return (
    <Link
      href={href}
      className={cn(
        "group relative inline-flex rounded-xl bg-linear-to-br from-primary/45 via-accent-2/28 to-primary/25 p-px no-underline outline-none transition-[transform,box-shadow] duration-300",
    ...
    >
      <span
        className={cn(
          ...
          "ring-1 ring-inset ring-white/5 transition-colors duration-300",
